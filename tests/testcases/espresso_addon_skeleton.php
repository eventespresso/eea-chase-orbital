...
class espresso_promotions_tests extends EE_UnitTestCase {
	 ...
	 * @since 0.0.1.dev.002
	 */
	function test_loading_chase_orbital() {
		$this->assertEquals( has_action('AHEE__EE_System__load_espresso_addons', 'load_espresso_chase_orbital'), 10 );
		$this->assertTrue( class_exists( 'EE_Chase_Orbital' ) );
	}
}
